      ...
      <header className="header px-4  pt-3 pb-1 fixed w-[100%] top-0 items-center bg-white z-10 hidden md:block">
        <div className="grid grid-cols-12">
          <div className="col-span-2 flex items-center ">
            ...
            <Link to="/" >
              <div className="header-logo w-[6rem] h-10 ml-5" >
                <svg xmlns="http://www.w3.org/2000/svg" id="yt-logo-updated-svg_yt1" className="external-icon" viewBox="0 0 90 20" focusable="false" style={{ pointerEvents: "none", display: "inherit", width: "100%", height: "100%" }}>
          ...
          <div className="col-span-8">
            <div className="search-bar items-center flex justify-center">
              <input type="text" placeholder="Search" className="w-[40rem] h-10 p-2 pl-10 rounded-l-full border  border-gray-200 appearance-none focus:outline-none "
                value={searchValue}
            ...
            {isSuggestionBoxOpen && <div className="w-full z-10 flex justify-center items-center">
              <div className="absolute top-14 w-[40rem] mr-12  rounded-2xl bg-white py-4 shadow-lg">
          ...
          <div className="col-span-2">
            <div className="flex justify-end items-center mx-2 ">
              <div className="notification-icon p-2 cursor-pointer">
                <MdOutlineVideoCall className="w-6 h-6 mx-2" />
              </div>
              <div className="notification-icon p-2 cursor-pointer">
          ...
          <div className={"col-span-12 py-2 " + (searchShowMobile ? "block" : "hidden")}>
            <div className="flex items-center">
              ...
              <div className="search-bar flex items-center justify-center">
                <input type="text" placeholder="Search" className="w-72 md:w-[40rem] h-10 p-2 md:pl-10 rounded-l-full border  border-gray-200 appearance-none focus:outline-none  "
                  value={searchValue}
                  onChange={(e) => onChangeHandler(e)}
                  onFocus={() => searchValue.length != 0 && setIsSuggestionBoxOpen(true)}
                  // onBlur={() => setIsSuggestionBoxOpen(false)}
                  onKeyDown={(e) => onKeyDownHandler(e)}
                />
                <span className="search-icon py-2 pr-2 pl-1 h-10 w-14  items-center center rounded-r-full cursor-pointer bg-gray-100"
                  onClick={() => searchHandler()}
                >
                  <CiSearch className="w-5 h-5 ml-2" />
                </span>
            ...
            {isSuggestionBoxOpen && <div className="w-full z-10 justify-center items-center  ">
              <div className="absolute top-14 w-[95%] md:w-[40rem] md:mr-12  rounded-2xl bg-white py-4 shadow-lg ">
                <div className="suggestion-items">
                  <ul className="">
                    {suggestionItems.map((item, index) => {
                      return (
